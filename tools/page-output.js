      ...
      try {
        ...
        if (cached) {
          try {
            ...
            setProject({ id: projectId, name: parsed.name || "未命名项目", description: null, created_at: new Date().toISOString(), project_info: parsed.project_info || null });
        ...
        } else { console.error("获取项目失败:", json.error); }
